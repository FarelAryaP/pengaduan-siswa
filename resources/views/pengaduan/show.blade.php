        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center gap-3">
                    <a href="{{ route('pengaduan.index') }}" class="flex items-center gap-3 hover:opacity-80 transition">
        ...
        <div class="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
            ...
            <div class="p-8">
                ...
                <div class="flex flex-col sm:flex-row gap-3 pt-6 border-t border-gray-200">
                    <a href="{{ route('pengaduan.index') }}" class="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-3 rounded-xl transition-all duration-200 flex items-center justify-center gap-2">
                    ...
                    @if($pengaduan->status === 'pending')
                        <form action="{{ route('pengaduan.destroy', $pengaduan->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus pengaduan ini?')" class="flex-1">
                            @csrf
                            @method('DELETE')
