        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('pengaduan.create') }}" class="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary to-blue-600 text-white rounded-xl font-medium hover:shadow-lg transition-all duration-200">
        ...
        @if($pengaduanList->isEmpty())
            <div class="bg-white rounded-3xl shadow-lg p-12 text-center border border-gray-100">
                <div class="flex flex-col items-center">
                    ...
                    <a href="{{ route('pengaduan.create') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary to-blue-600 text-white rounded-xl font-semibold hover:shadow-lg transition-all duration-200">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                        </svg>
                        Buat Pengaduan Baru
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                ...
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('pengaduan.show', $pengaduan->id) }}" class="px-4 py-2 bg-blue-50 text-primary rounded-lg font-medium hover:bg-blue-100 transition-colors text-sm">
                                        Detail
                                    </a>
                                    @if($pengaduan->status === 'pending')
